...
export const AboutModalBoxContent = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: css(styles.aboutModalBoxContent) }, props),
        React.createElement("div", { className: css('pf-c-about-modal-box__body') }, hasNoContentContainer ? children : React.createElement("div", { className: css(contentStyles.content) }, children)),
