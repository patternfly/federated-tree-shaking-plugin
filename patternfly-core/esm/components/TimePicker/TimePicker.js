                ...
                React.createElement(InputGroup, null,
                    React.createElement("div", { id: randomId },
                        React.createElement("div", { ref: this.toggleRef, style: { paddingLeft: '0' } },
                            React.createElement(Popper, { appendTo: calculatedAppendTo, trigger: textInput, triggerRef: this.inputRef, popper: menuContainer, popperRef: this.menuRef, isVisible: isTimeOptionsOpen, zIndex: zIndex })))),
                isInvalid && (React.createElement("div", { className: css(datePickerStyles.datePickerHelperText) }, !isValidFormat ? invalidFormatErrorMessage : invalidMinMaxErrorMessage)))));
    }
}
