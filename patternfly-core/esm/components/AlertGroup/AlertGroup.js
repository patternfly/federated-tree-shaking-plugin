...
export class AlertGroup extends React.Component {
    ...
    render() {
        const _a = this.props, { className, children, isToast, isLiveRegion, onOverflowClick, overflowMessage, 'aria-label': ariaLabel } = _a, props = __rest(_a, ["className", "children", "isToast", "isLiveRegion", "onOverflowClick", "overflowMessage", 'aria-label']);
