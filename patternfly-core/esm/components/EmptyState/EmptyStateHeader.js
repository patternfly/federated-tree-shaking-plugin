...
export const EmptyStateHeader = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: css('pf-c-empty-state__header', className) }, props),
        icon,
        (titleText || children) && (React.createElement("div", { className: css('pf-c-empty-state__title') },
