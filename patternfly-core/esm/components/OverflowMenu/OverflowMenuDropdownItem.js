...
export const OverflowMenuDropdownItem = (_a) => {
    ...
    return (React.createElement(OverflowMenuContext.Consumer, null, (value) => (!isShared || value.isBelowBreakpoint) && (React.createElement(DropdownItem, Object.assign({ component: "button", itemId: itemId }, additionalProps), children))));
};
