...
export const NotificationDrawerList = (_a) => {
    ...
    return (React.createElement("ul", Object.assign({}, props, { className: css('pf-c-notification-drawer__list', className), hidden: isHidden, role: "list", "aria-label": ariaLabel }), children));
};
