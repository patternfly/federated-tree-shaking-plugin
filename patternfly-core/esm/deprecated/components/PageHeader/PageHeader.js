...
export const PageHeader = (_a) => {
    var { className = '', logo = null, logoProps = null, logoComponent, headerTools = null, topNav = null, isNavOpen = true, role = undefined, showNavToggle = false, navToggleId = 'nav-toggle', onNavToggle = () => undefined, 'aria-label': ariaLabel = 'Global navigation', 'aria-controls': ariaControls = null } = _a, props = __rest(_a, ["className", "logo", "logoProps", "logoComponent", "headerTools", "topNav", "isNavOpen", "role", "showNavToggle", "navToggleId", "onNavToggle", 'aria-label', 'aria-controls']);
