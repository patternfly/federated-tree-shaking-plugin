...
const OverflowMenuDropdownItem = (_a) => {
    ...
    return (React.createElement(OverflowMenuContext_1.OverflowMenuContext.Consumer, null, (value) => (!isShared || value.isBelowBreakpoint) && (React.createElement(Dropdown_1.DropdownItem, Object.assign({ component: "button", itemId: itemId }, additionalProps), children))));
};
