...
const LoginForm = (_a) => {
    ...
    return (React.createElement(Form_1.Form, Object.assign({ className: className }, props),
        ...
        rememberMeLabel.length > 0 && (React.createElement(Form_1.FormGroup, { fieldId: "pf-login-remember-me-id" },
            React.createElement(Checkbox_1.Checkbox, { id: "pf-login-remember-me-id", label: rememberMeLabel, isChecked: isRememberMeChecked, onChange: (event, checked) => onChangeRememberMe(checked, event) }))),
