...
const FileUpload = (_a) => {
    ...
    const { getRootProps, getInputProps, isDragActive, open, inputRef } = (0, react_dropzone_1.useDropzone)(Object.assign(Object.assign({ multiple: false }, dropzoneProps), { onDropAccepted,
        onDropRejected }));
