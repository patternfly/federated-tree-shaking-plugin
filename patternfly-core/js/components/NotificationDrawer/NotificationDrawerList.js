...
const NotificationDrawerList = (_a) => {
    ...
    return (React.createElement("ul", Object.assign({}, props, { className: (0, react_styles_1.css)('pf-c-notification-drawer__list', className), hidden: isHidden, role: "list", "aria-label": ariaLabel }), children));
};
