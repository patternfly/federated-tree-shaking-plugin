...
const AboutModalBoxContent = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(about_modal_box_1.default.aboutModalBoxContent) }, props),
        React.createElement("div", { className: (0, react_styles_1.css)('pf-c-about-modal-box__body') }, hasNoContentContainer ? children : React.createElement("div", { className: (0, react_styles_1.css)(content_1.default.content) }, children)),
