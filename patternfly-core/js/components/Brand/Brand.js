...
const Brand = (_a) => {
    ...
    if (children !== undefined && widths !== undefined) {
        responsiveStyles = Object.assign({}, (0, helpers_1.setBreakpointCssVars)(widths, '--pf-c-brand--Width'));
    }
    if (children !== undefined && heights !== undefined) {
        responsiveStyles = Object.assign({}, (0, helpers_1.setBreakpointCssVars)(heights, '--pf-c-brand--Height'));
    }
    return (
    ...
    children !== undefined ? (React.createElement("picture", Object.assign({ className: (0, react_styles_1.css)(brand_1.default.brand, brand_1.default.modifiers.picture, className), style: Object.assign(Object.assign({}, style), responsiveStyles) }, props),
        children,
        React.createElement("img", { src: src, alt: alt }))) : (React.createElement("img", Object.assign({}, props, { className: (0, react_styles_1.css)(brand_1.default.brand, className), style: style, src: src, alt: alt }))));
};
exports.Brand = Brand;
