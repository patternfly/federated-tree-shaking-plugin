...
const EmptyStateIcon = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(empty_state_1.default.emptyStateIcon) }, (color && !iconIsSpinner && { style: { ['--pf-c-empty-state__icon--Color']: color } })),
