...
class TimePicker extends React.Component {
    ...
    render() {
        ...
        const textInput = (React.createElement(TextInput_1.TextInput, Object.assign({ "aria-haspopup": "menu", className: (0, react_styles_1.css)(form_control_1.default.formControl), id: `${randomId}-input`, "aria-label": ariaLabel, validated: isInvalid ? 'error' : 'default', placeholder: placeholder, value: timeState || '', type: "text", iconVariant: "clock", onClick: this.onInputClick, onChange: this.onInputChange, autoComplete: "off", isDisabled: isDisabled, ref: this.inputRef }, inputProps)));
                ...
                React.createElement(InputGroup_1.InputGroup, null,
                    React.createElement("div", { id: randomId },
                        React.createElement("div", { ref: this.toggleRef, style: { paddingLeft: '0' } },
                            React.createElement(Popper_1.Popper, { appendTo: calculatedAppendTo, trigger: textInput, triggerRef: this.inputRef, popper: menuContainer, popperRef: this.menuRef, isVisible: isTimeOptionsOpen, zIndex: zIndex })))),
                isInvalid && (React.createElement("div", { className: (0, react_styles_1.css)(date_picker_1.default.datePickerHelperText) }, !isValidFormat ? invalidFormatErrorMessage : invalidMinMaxErrorMessage)))));
    }
}
